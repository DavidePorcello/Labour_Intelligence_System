...
class Topic_modeling():
    ...
    def import_data(self):
        data = pd.read_excel(self.path,header=None)
    ...
    def word_correction(self):
        changes = [('ঞ', 'ti'), ('Ć', 'fi'), ('Õ', 'fi'), ('ß', 'fi'),('ø', 'fi'), ('Ą', 'ff'), ('Ö', 'fl'), ('ϐ', 'f'), ('', 'tt'), ('profle', 'profile'), ('mob','job'), ('wicker','picker'),('fires','fries'),('rickets','picker'),('accommodationwijk','accommodation area'),('coer','euro')]
    ...
    def remove_stopwords(self, texts):
        ...
        stop_words.extend(['jobs','job','work','works','working', 'netherlands','nederland', 'king'])
    ...
    def modeling(self,limit=15, start=2, step=1, num_topics =None):
    ...
    def compute_coherence_values(self,limit,start,step):
        ...
        best_n_topics = (coherence_values.index(max(coherence_values))+start)*step
